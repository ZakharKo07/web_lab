function Employee(name, lastName, baseSalary, experience){
  ...
  Department.prototype.giveSalary = function() {
   ...
   function main() {
      const dev = new Developer("Alex", "Best", 1000, 5);
        const dev2 = new Developer("Max", "Allison", 1000, 1);
        const dev3 = new Developer("Kyle", "Duba", 1200, 9);
        const dev4 = new Developer("Jack", "Grealish", 1100, 9);
    const des = new Designer("Joe", "Biden", 1200, 6, 0.5);
    const des1 = new Designer("Michael", "Jackson", 1000, 6, 0.7);
    const manager = new Manager("Jude", "Bellingham", 1400, 5, [dev, dev2, dev3, dev4,des,des1]);
